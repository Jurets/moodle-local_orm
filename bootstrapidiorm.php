...
/**
 * Adapter for original vendor idiorm bootstrap
...
// Include original idiorm bootstrap file
require_once(dirname(__FILE__) . '/vendor/j4mie/idiorm/test/bootstrap.php');
